 ...
 */
public class NonMetaliFragment extends BaseFragment {

    public NonMetaliFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_non_metali, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        textViewDescription.setText(Html.fromHtml(getString(R.string.text_non_metali)));
