 ...
 */
public class GasRariFragment extends BaseFragment {

    public GasRariFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_gas_gari, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        textViewDescription.setText(Html.fromHtml(getString(R.string.text_gas_gari)));
