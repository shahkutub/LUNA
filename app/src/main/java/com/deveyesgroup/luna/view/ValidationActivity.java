...
public class ValidationActivity extends Activity {
    ...
    TextView tvConFirmBtn, tvSendPass, tvRemember, tvForLogin;
    MediaPlayer mp;
    ...
    private void initUI() {
        tvConFirmBtn = (TextView)findViewById(R.id.tvConFirmBtn);
        etValidationCode = (EditText) findViewById(R.id.etValidationCode);
        ...
        tvConFirmBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                finish();
//                if(TextUtils.isEmpty(etValidationCode.getText().toString())){
//                    AlertMessage.showMessage(con,getString(R.string.app_name),"Enter Validation Code");
//                }else {
