 ...
 */
public class SemiMetaliFragment extends BaseFragment {

    public SemiMetaliFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_semi_metali, container, false);
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        textViewDescription.setText(Html.fromHtml(getString(R.string.text_semi_metali)));
